        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.index">
                <dt class="title">选择{{spuSaleAttr.saleAttrName}}</dt>
                <dd
                  changepirce="0"
                  :class="{active:spuSaleAttrValue.isChecked==1}"
                  v-for="spuSaleAttrValue in spuSaleAttr.spuSaleAttrValueList"
                  :key="spuSaleAttrValue.index"
                  @click="selectSpuSaleAttrValue(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
...
export default {
  ...
  methods: {
    selectSpuSaleAttrValue(spuSaleAttrValue, spuSaleAttrValueList) {
      spuSaleAttrValueList.forEach((spuSaleAttr) => {
